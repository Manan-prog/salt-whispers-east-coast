                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div className="bg-gradient-warning text-white rounded-full w-25 h-25 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                        $27B+
                      </div>
                    ...
                    <div className="text-center">
                      <div className="bg-ocean-medium text-white rounded-full w-25 h-25 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                        $20-40B/year
                      </div>
                    ...
                    <div className="text-center">
                      <div className="bg-destructive text-white rounded-full w-25 h-25 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                        $23B/year
                      </div>
